      ...
      <div class="modal-dialog">
        <form @submit.prevent="submitForm" class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control" v-model="form.copyright" />
            ...
            <!-- versi dengan cleave -->
            <div class="form-floating mb-3">
              <input type="text" class="form-control" v-model="form.versi" v-cleave-number />
              <label>Versi</label>
            </div>
...
export default {
  ...
  mounted() {
    ...
    $("#tableSoftware").on("click", ".btn-edit", this.dtEditClickHandler);
  ...
  beforeUnmount() {
    ...
    if (this.dtEditClickHandler) {
      $("#tableSoftware").off("click", ".btn-edit", this.dtEditClickHandler);
    ...
    if ($.fn.dataTable && $.fn.dataTable.isDataTable("#tableSoftware")) {
      try {
        $("#tableSoftware").DataTable().destroy(true);
      } catch (e) {
        // ignore
      }
    }
  ...
  methods: {
    ...
    initDataTable() {
      if ($.fn.dataTable && $.fn.dataTable.isDataTable("#tableSoftware")) {
        $("#tableSoftware").DataTable().destroy();
      }

      this.table = $("#tableSoftware").DataTable({

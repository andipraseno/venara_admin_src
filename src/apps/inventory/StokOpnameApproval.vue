    ...
    <div class="mb-3 mt-3">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Stok Opname Approval</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3 position-relative">
              <Cleave
                ...
                id="filterTglInventory"
                class="form-control pe-5"
                placeholder="dd/mm/yyyy"
              />
              <label for="filterTglInventory">Tgl. Transaksi</label>
...
export default {
  ...
  methods: {
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/inventory/stok_opname`;
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/inventory/stok_opname_show/${id}`;
      try {
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/inventory/stok_opname_add`;
...
<style scoped src="@/apps/inventory/stokopname.css"></style>

          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <select
                ...
                id="formGudangAsal"
                :class="{ 'is-invalid': errors.gudang_id }"
              >
                <option value="">Pilih Gudang</option>
                <option v-for="s in gudangList" :key="s.id" :value="s.id">
                  {{ s.nama }}
                </option>
              </select>
              <label for="formGudangAsal" class="form-label">Gudang</label>
              <div class="invalid-feedback" v-if="errors.gudang_id">
                {{ errors.gudang_id[0] }}
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/inventory/waste`;
          ...
          },
          {
            ...
            render(row) {
              ...
              button =
                button +
                `<button 
                        class="btn btn-sm btn-danger btn-edit-router"
                        data-id="${row.id}"
                      >
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/inventory/waste_show/${id}`;
      try {
        ...
        this.form.gudang_id = data.gudang_id ?? "";
    ...
    async submitForm() {
      ...
      const tglUS = this.dateIndoToUS(this.form.tgl_transaksi);
      if (!tglUS) {
        alert("Tanggal transaksi tidak valid");
        return;
      }
      ...
      try {
        ...
        /**
         * ✅ PERSIS SEPERTI KLIK EDIT DI DATATABLE
         */
...
<style scoped src="@/apps/inventory/waste.css"></style>

    ...
    <div class="mb-3 mt-3">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Overzak</li>
        </ol>
      </nav>
    </div>
...
export default {
  ...
  methods: {
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/inventory/overzak`;
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/inventory/overzak_show/${id}`;
      try {
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/inventory/overzak_add`;
...
<style scoped src="@/apps/inventory/overzak.css"></style>

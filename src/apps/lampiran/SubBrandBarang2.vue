    ...
    <div class="mb-3 mt-3">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Sub Brand Barang 2</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="modal-dialog">
        <form @submit.prevent="submitForm" class="modal-content">
          ...
          <div class="modal-body">
            ...
            <!-- Group1 -->
            <div class="form-floating mb-3">
              <select class="form-select" v-model="form.level1_id" id="formGroup1">
                <option value="">Pilih Group 1</option>
                <option v-for="s in group1List" :key="s.id" :value="s.id">
                  {{ s.nama }}
                </option>
              </select>
              <label for="formGroup1" class="form-label">Group 1</label>
            </div>
      ...
      <div class="modal-dialog">
        <form @submit.prevent="doSearch" class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <select class="form-select" v-model="filter.level1_id" id="filterGroup1">
                <option value="">Pilih Group 1</option>
              ...
              <label for="filterGroup1" class="form-label">Group 1</label>
            </div>
...
export default {
  ...
  methods: {
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/lampiran/sub_brand_barang_2`;
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/lampiran/sub_brand_barang_2_show/${id}`;
      try {
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/lampiran/sub_brand_barang_2_add`;
      const payload = {
...
<style scoped src="@/apps/lampiran/subbrandbarang2.css"></style>

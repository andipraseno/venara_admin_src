...
export default {
  ...
  methods: {
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/beli/retur`;
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/beli/retur_show/${id}`;
      try {
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/beli/retur_add`;
...
<style scoped src="@/apps/beli/retur.css"></style>

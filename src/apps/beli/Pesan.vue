        ...
        <form @submit.prevent="submitForm" class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              ...
              <label for="formGudang" class="form-label">Gudang</label>
...
export default {
  ...
  mounted() {
    ...
    $("#tableMain").on("click", ".btn-edit-router", this.dtEditClickHandler);
  ...
  beforeUnmount() {
    if (this.dtEditClickHandler) {
      $("#tableMain").off("click", ".btn-edit-router", this.dtEditClickHandler);
  ...
  methods: {
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/beli/pesan`;
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/beli/pesan_show/${id}`;
      try {
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/beli/pesan_add`;
...
<style scoped src="@/apps/beli/pesan.css"></style>

    ...
    <div class="mb-3 mt-3">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 small">
          ...
          <li class="breadcrumb-item active" aria-current="page">Akun Level 3</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="modal-dialog">
        <form @submit.prevent="submitForm" class="modal-content">
          ...
          <div class="modal-body">
            ...
            <!-- Level2 -->
            <div class="form-floating mb-3">
              <select class="form-select" v-model="form.level2_id" id="level2Select">
      ...
      <div class="modal-dialog">
        <form @submit.prevent="doSearch" class="modal-content">
          ...
          <div class="modal-body">
            ...
            <!-- Level2 Filter -->
            <div class="form-floating mb-3">
              <select class="form-select" v-model="filter.level2_id">
                <option value="">Pilih Level 2</option>
                <option v-for="s in level2List" :key="s.id" :value="s.id">
                  {{ s.nama }}
                </option>
...
export default {
  ...
  methods: {
    // ---------- load Level1 / Level2 / Akun Level 3 ----------
    ...
    // ---------- DataTable init ----------
    initDataTable() {
      const url = `${this.baseUrl}/lampiran/akun_level_3`;
    ...
    async openEditModal(id) {
      ...
      try {
        const url = `${this.baseUrl}/lampiran/akun_level_3_show/${id}`;
        const res = await axios.get(url, this.tokenHeaders);
        const data = res.data || {};
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/lampiran/akun_level_3_add`;
      const payload = {
...
<style scoped src="@/apps/lampiran/AkunLevel3.css"></style>

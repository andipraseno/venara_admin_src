  ...
  methods: {
    ...
    initDataTable() {
      ...
      this.table = $("#tableMain").DataTable({
        ...
        pageLength: 25,
        ajax: {
          url: `${this.baseUrl}/lampiran/availability_barang`,
          type: "GET",
    ...
    async openEditModal(id) {
      ...
      try {
        const res = await axios.get(
          `${this.baseUrl}/lampiran/availability_barang_show/${id}`,
          this.tokenHeaders
        );
        const data = res.data || {};
    ...
    async submitForm() {
      ...
      try {
        await axios.post(
          `${this.baseUrl}/lampiran/availability_barang_add`,
          payload,
          this.tokenHeaders
        );

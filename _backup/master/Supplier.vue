...
export default {
  ...
  methods: {
    ...
    async loadGroupList() {
      try {
        const url = `${this.baseUrl}/lampiran/group_supplier_combo`;
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/master/supplier`;
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/master/supplier_show/${id}`;
      try {
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/master/supplier_add`;
...
<style scoped src="@/apps/master/supplier.css"></style>

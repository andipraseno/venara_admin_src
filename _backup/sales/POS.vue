    ...
    <div class="mb-3 mt-3">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">P.O.S.</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <select
                ...
                id="formStation"
                :class="{ 'is-invalid': errors.station_id }"
              >
                <option value="">Pilih Station</option>
                <option v-for="s in stationList" :key="s.id" :value="s.id">
                  {{ s.nama }}
                </option>
              </select>
              <label for="formStation" class="form-label">Station</label>
              <div class="invalid-feedback" v-if="errors.station_id">
                {{ errors.station_id[0] }}
              </div>
            </div>
            ...
            <div class="form-floating mb-3">
              <select
                class="form-select"
                v-model="form.kasir_id"
                id="formKasir"
                :class="{ 'is-invalid': errors.kasir_id }"
              >
                <option value="">Pilih Kasir</option>
                <option v-for="s in kasirList" :key="s.id" :value="s.id">
                  {{ s.nama }}
                </option>
              </select>
              <label for="formKasir" class="form-label">Kasir</label>
              <div class="invalid-feedback" v-if="errors.kasir_id">
                {{ errors.kasir_id[0] }}
              </div>
            </div>
            ...
            <div class="form-floating mb-3">
              <select
                ...
                id="formSalesman"
                :class="{ 'is-invalid': errors.salesman_id }"
              >
              ...
              <label for="formSalesman" class="form-label">Salesman</label>
              <div class="invalid-feedback" v-if="errors.salesman_id">
                {{ errors.salesman_id[0] }}
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    async loadStationList() {
      try {
        const url = `${this.baseUrl}/profile/station_combo`;
        const res = await axios.get(url, this.tokenHeaders);
        this.stationList = res.data || [];
      } catch (e) {
        console.error("loadStationList", e);
    ...
    async loadKasirList() {
      try {
        const url = `${this.baseUrl}/master/karyawan_combo`;
        const res = await axios.get(url, this.tokenHeaders);
        this.kasirList = res.data || [];
      } catch (e) {
        console.error("loadKasirList", e);
        alert("Gagal memuat data. Silakan coba lagi.");
      }
    },
    ...
    async loadSalesmanList() {
      try {
        ...
        console.error("loadSalesmanList", e);
        alert("Gagal memuat data. Silakan coba lagi.");
      }
    },
    ...
    // init datatable
    initDataTable() {
      const url = `${this.baseUrl}/sales/pos`;
    ...
    async openEditModal(id) {
      ...
      const url = `${this.baseUrl}/sales/pos_show/${id}`;
      try {
        ...
        this.form.kasir_id = data.kasir_id ?? "";
    ...
    async submitForm() {
      ...
      const url = `${this.baseUrl}/sales/pos_add`;
...
<style scoped src="@/apps/sales/pos.css"></style>
